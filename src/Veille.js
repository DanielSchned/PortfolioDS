  ...
  useEffect(() => {
    ...
    return (
      ...
      <div >     
        ...
        <p data-aos="fade-left" className ="veille" style = {{color:'white', marginLeft:'30%', marginTop:'-27%', maxWidth:560, backgroundColor:'#2b2b2b', borderRadius: 5}}>Avec l'application LeMonde, je suis tenu d'actualité par ce qu'il se passe technologiquement, avec l'onglet 'pixel', de nombreuses informations sont essentielles, mais généralement, cela tourne autour de la cybersécurité, avec notamment la fuite de 500000 données médicales le 24 février 2021 </p>
